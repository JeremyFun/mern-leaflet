            ...
            {data.map(f => (
                ...
                >
                    <Popup minWidth={200} closeButton={false}>
                        <div>
                            <b style={{fontFamily: "Roboto", fontStyle: "italic", fontWeight: "500", fontSize: "16px"}}>Hello</b>
                            <p style={{fontFamily: "sans-serif", fontWeight: "500", fontSize: "16px"}} >I am {f.properties.name}</p>
                        </div>
                    </Popup>
                </Marker>
            ))}
